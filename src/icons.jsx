...
export const IconCalculators = createIcon(
  <>
    <path d="M4 4h16v16H4V4zM4 9h16M9 4v16" />
    <path d="M16 14l-2 2 2 2M12 14l2 2-2 2" />
  </>
);

export const IconDrugs = createIcon(
  <>
    <path d="M15.75 5.25a3 3 0 0 1 3 3m-3-3a3 3 0 0 0-3 3m3-3v6" />
    <path d="M20.25 12.75a3 3 0 0 1-3 3m3-3a3 3 0 0 0-3-3m3 3H6.75" />
    <circle cx="4.5" cy="16.5" r="2.25" />
  </>
);
...
export const IconGames = createIcon(
  <>
    <path d="M21 16.8c0-1.44-1.184-2.61-2.638-2.61h-2.3c.388.448.638 1.058.638 1.75V17.1c0 .692-.25 1.302-.638 1.75h2.3c1.454 0 2.638-1.17 2.638-2.61v-.64Z" />
    <path d="M3 16.8c0-1.44 1.184-2.61 2.638-2.61h2.3a2.62 2.62 0 0 0-.638 1.75V17.1c0 .692.25 1.302.638 1.75h-2.3C4.184 18.85 3 17.68 3 16.24v-.64Z" />
    <path d="M10.5 7.8v4.5M8.25 10h4.5" />
    <circle cx="12" cy="6.75" r="4" />
  </>
);
...
export const IconMicroscope = createIcon(
  <>
    <path d="M6.75 3v3.75M9.75 3v3.75M12 8.25a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" />
    <path d="M9.75 12.75V21h4.5v-8.25" />
  </>
);
