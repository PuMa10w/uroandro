const adrenalIncidentalomaData = {
  ...
  icon: '🧭',
  description:
    'Случайно выявленное образование надпочечника, требующее оценки гормональной активности и онкологического риска.',
  tags: ['ESE 2023', 'EAU 2025'],
  relatedIds: ['adrenal-cancer', 'paraganglioma-bladder', 'hyperprolactinemia-male'],
  definition:
    'Образование надпочечника, обнаруженное случайно при визуализации, выполненной не по поводу adrenal disease.',
  epidemiology: 'Частота растёт с возрастом и доступностью КТ/МРТ.',
  classification: [
    { type: 'Гормонально-активная', desc: 'Кортизол, альдостерон, катехоламины и др.' },
    { type: 'Неактивная', desc: 'Без явной гормональной секреции' },
  ],
  etiology: ['Аденома', 'Гиперплазия', 'Адренокортикальный рак', 'Метастаз', 'Феохромоцитома'],
  symptoms: [
    'Часто нет симптомов',
    'Иногда признаки гормональной гиперсекреции',
    'Боль при крупных размерах',
  ],
  diagnostics: {
    primary: ['КТ/МРТ надпочечников', 'Скрининг на гормональную активность'],
    additional: ['Метанефрины', 'Тест с дексаметазоном', 'Альдостерон/ренин по показаниям'],
    keyFindings: 'Нужно определить размер, плотность, washout и гормональную активность.',
  },
  treatment: [
    'Наблюдение при малых неактивных образованиях',
    'Адреналэктомия при подозрении на злокачественность или гормональную активность',
  ],
  guidelines: {
    eau: {
  ...
  quickSummary:
    'Каждая инциденталома должна быть оценена на гормональную активность и malignant potential.',
  prognosis:
    'В большинстве случаев благоприятный, если исключена активная или злокачественная природа.',
  followUp: 'Повторная визуализация и гормональный контроль по размеру и риску.',
  lifestyleAdvice: [
    'Контролировать давление, массу тела и метаболические факторы.',
    'Не игнорировать рекомендованное гормональное обследование.',
  ],
  nutritionAdvice: ['При доказанном гиперкортицизме важны коррекция веса и углеводного обмена.'],
  patientRecommendations: [
    'Не все опухоли надпочечника опасны, но каждая требует правильного первичного разбора.',
  ],
  clinicalCases: [
    {
      title: 'Клинический случай №1',
      patient: 'Женщина 63 лет',
      complaint: 'Жалоб нет.',
      findings: 'На КТ живота случайно выявлено образование надпочечника 2.2 см низкой плотности.',
      diagnosis: 'Неактивная аденома надпочечника.',
      treatment: 'Наблюдение.',
      outcome: 'Без роста и гормональной активности.',
      lesson: 'Не каждая инциденталома требует операции, но каждая требует стратификации риска.',
    },
  ],
  patientQuestions: [
    {
      q: 'Это рак?',
      a: 'Не обязательно. Большинство небольших инциденталом — доброкачественные, но их нужно оценивать по правилам.',
    },
  ],
  drugDoses: [],
};
