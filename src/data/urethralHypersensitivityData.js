const urethralHypersensitivityData = {
  ...
  icd: "N36.8",
  icon: "⚡",
  description: "Хроническая болезненность и гиперестезия уретры, вызывающая дисурию и болевой синдром без подтверждённой инфекции.",
  tags: ["EAU 2025", "AUA 2025", "РКР 2024", "UA 2025"],
  relatedIds: ["urethritis", "chronic-prostatitis-cpps", "interstitial-cystitis"],
  pathogenesis: "Гипервозбудимость нервных окончаний уретры вследствие хронической воспалительной реакции, дегенеративных изменений или психогенной сенсибилизации. Повреждение барьерной функции эпителия → чувствительность к механическим и химическим раздражителям.",
  complications: [
    ...
    surgical: [
      {
        ...
        items: [
          "Уретроскопия при стенозе",
          "Лазерное удаление гиперстимуляции"
        ]
      }
    ]
  },
