const bladderEndometriosisData = {
  ...
  icon: '🔬',
  description:
    'Форма глубокого инфильтративного эндометриоза с поражением стенки мочевого пузыря и циклическими мочевыми симптомами.',
  tags: ['EAU 2025', 'РКР 2024'],
  relatedIds: ['interstitial-cystitis', 'hematuria', 'bladder-pain-syndrome'],
  definition:
    'Эктопическая эндометриоидная ткань в стенке мочевого пузыря, вызывающая хронические и циклические урологические симптомы.',
  epidemiology:
    'Относительно редкая, но важная причина тазовой боли, дизурии и циклической гематурии у женщин.',
  classification: [
    { type: 'Поверхностный', desc: 'Ограничен слизистой/серозой' },
    { type: 'Инфильтративный', desc: 'Поражает мышечный слой и глубже' },
  ],
  etiology: [
    'Глубокий инфильтративный эндометриоз',
    'Гормонозависимый рост очагов',
    'Послеоперационное распространение',
  ],
  symptoms: [
    'Циклическая дизурия',
  ...
  diagnostics: {
    primary: ['Анамнез с цикличностью симптомов', 'МРТ малого таза', 'Цистоскопия'],
    additional: ['Консультация гинеколога', 'УЗИ малого таза'],
    keyFindings: 'Связь симптомов с циклом и локальное поражение стенки мочевого пузыря.',
  },
  treatment: [
    'Гормональная терапия',
    'Хирургическое иссечение при выраженных симптомах или глубоком поражении',
    'Мультидисциплинарный подход с гинекологом',
  ],
  guidelines: {
    eau: {
  ...
  lifestyleAdvice: [
    'Вести дневник симптомов с привязкой к менструальному циклу.',
    'Обсуждать сочетанное ведение у уролога и гинеколога.',
  ],
  nutritionAdvice: [
    'Поддерживать противовоспалительный рацион и контроль массы тела как часть общего ведения хронической боли.',
  ],
  patientRecommendations: [
    'Сообщать врачу о циклической гематурии или дизурии.',
    'Не списывать рецидивирующие симптомы только на цистит без повторной оценки.',
  ],
  clinicalCases: [
    {
      title: 'Клинический случай №1',
      patient: 'Женщина 34 лет',
      complaint: 'Циклическая дизурия и макрогематурия.',
      findings: 'МРТ: очаг в задней стенке мочевого пузыря.',
      diagnosis: 'Эндометриоз мочевого пузыря.',
      treatment: 'Гормональная терапия, затем частичная резекция.',
      outcome: 'Регресс симптомов.',
      lesson: 'Цикличность симптомов — сильный red flag в пользу эндометриоза.',
    },
  ],
  patientQuestions: [
    {
      q: 'Почему это похоже на цистит?',
      a: 'Потому что симптомы действительно похожи, но у эндометриоза часто есть связь с менструальным циклом.',
    },
  ],
  drugDoses: [],
};
