const catheterComplicationData = {
  ...
  icon: '⚠️',
  description:
    'Осложнения индвазивного мочехваточника: кровотечение, травма слизистой, экструз (выведение), инфицирование.',
  tags: ['EAU Urological Infections', 'AUA Guidelines', 'РКР 2024'],
  relatedIds: ['urethral-stricture', 'hematuria', 'urinary-retention'],
  definition:
    'Большие механические проблемы с мочехваточником, включая кровотечение, травму, экструз и необходимость замены.',
