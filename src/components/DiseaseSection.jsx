    ...
    return (
      <section className="section" aria-label={title}>
        ...
        <p className="section-subtitle">
          {subtitle ||
            'Выберите карточку, чтобы быстро перейти к диагностике, лечению, красным флагам и маршрутизации.'}
        </p>
            ...
            {sortedData.map((disease, index) => (
              ...
              >
                <button
                  ...
                  aria-label={
                    favorites[disease.id] ? 'Убрать из избранного' : 'Добавить в избранное'
                  }
                >
