const benignBladderNeoplasmData = {
  ...
  diagnostics: {
    ...
    imaging:
      'КТ-урография по показаниям для дифференциальной диагностики и оценки верхних мочевых путей.',
  ...
  guidelines: {
    ...
    ru: {
      title:
        'Российские клинические рекомендации по доброкачественным опухолям мочевого пузыря 2024',
      keyPoints: [
