...
export const SUBSECTION_TITLES = {
  urology: {
    ...
    infections: {
      title: 'Инфекции',
      icon: '🔥',
      desc: 'Цистит, пиелонефрит, абсцесс, гангрена Фурнье',
    },
    oncology: {
      title: 'Онкология',
      icon: '🎗️',
      desc: 'Рак простаты, мочевого пузыря, почки, яичка',
    },
    functional: {
      title: 'Функциональная',
      icon: '⚡',
      desc: 'ДГПЖ, ГАМП, семенные пузырьки, кисты простаты',
    },
    reconstructive: {
      title: 'Реконструктивная',
      icon: '🔧',
      desc: 'Стриктуры, свищи, дивертикулы, парафимоз, перекрут',
    },
    nephrology: {
      title: 'Нефрология',
      icon: '🫘',
      desc: 'Гломерулонефрит, ХБП, ОПП, поликистоз, стеноз, инфаркт, тромбоз',
    },
  ...
  andrology: {
    ...
    endocrine: {
      ...
      icon: '⚗️',
      desc: 'Гипогонадизм, гормональные нарушения',
    },
  },
};
