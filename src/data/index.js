...
export const allDiseases = [
  ...
  },
  {
    ...
    name: 'ИМП, связанная с катетером/устройством',
    icd: 'T83.5',
    section: 'urology',
    subsection: 'infections',
    icon: '⚠️',
  ...
  {
    id: 'upper-tract-uc',
    name: 'Уротелиальный рак верхних мочевых путей',
    icd: 'C65-C66',
    section: 'urology',
    subsection: 'oncology',
    icon: '🎗️',
  ...
  },
  {
    ...
    name: 'Интерстициальный цистит / СБМП',
    icd: 'N30.1',
    section: 'urology',
    subsection: 'functional',
    icon: '🔥',
  ...
  },
  {
    ...
    name: 'Послеоперационное недержание',
    icd: 'N39.4',
    section: 'urology',
    subsection: 'functional',
    icon: '💧',
  ...
  },
  {
    ...
    name: 'Пузырно-мочеточниковый рефлюкс',
    icd: 'N13.7',
    section: 'urology',
    subsection: 'reconstructive',
    icon: '🔧',
  ...
  {
    id: 'leukoplakia',
    name: 'Лейкоплакия мочевого пузыря',
    icd: 'N32.8',
    section: 'urology',
    subsection: 'reconstructive',
    icon: '🔬',
  ...
  },
  {
    ...
    name: 'Поликистозная болезнь почек',
    icd: 'Q61.2',
    section: 'urology',
    subsection: 'nephrology',
    icon: '🧬',
  ...
  },
  {
    ...
    name: 'Хронический простатит / СХТБ',
    icd: 'N41.1',
    section: 'andrology',
    subsection: 'sexual',
    icon: '⚡',
  ...
  },
  {
    ...
    name: 'Склероатрофический лихен полового члена',
    icd: 'L90.0',
    section: 'andrology',
    subsection: 'sexual',
    icon: '🔬',
  ...
  {
    id: 'sarcoma-prostate',
    name: 'Саркома предстательной железы',
    icd: 'C61',
    section: 'urology',
    subsection: 'oncology',
    icon: '🎗️',
  ...
  },
  {
    ...
    name: 'Субклинический гипогонадизм',
    icd: 'E29.1',
    section: 'andrology',
    subsection: 'endocrine',
    icon: '⚗️',
  ...
  },
  {
    ...
    name: 'Остеопороз при гипогонадизме',
    icd: 'M81.8',
    section: 'andrology',
    subsection: 'endocrine',
    icon: '⚗️',
  },
  {
    ...
    name: 'Дисфункция тазового дна у мужчин',
    icd: 'M62.8',
    section: 'andrology',
    subsection: 'sexual',
    icon: '⚡',
  ...
  },
  {
    ...
    name: 'Генитальный красный плоский лишай',
    icd: 'L43.9',
    section: 'andrology',
    subsection: 'sexual',
    icon: '🔬',
  ...
  },
  {
    ...
    name: 'Механическое осложнение катетера',
    icd: 'T83.5',
    section: 'urology',
    subsection: 'functional',
    icon: '⚠️',
...
const SEARCH_SYNONYMS = {
  ...
  'subclinical-hypogonadism': [
    'субклинический гипогонадизм',
    'низкий тестостерон',
    'пограничный тестостерон',
  ],
  'hyperprolactinemia-male': ['гиперпролактинемия', 'пролактин', 'высокий пролактин'],
  'chronic-bacterial-prostatitis': [
    'хронический бактериальный простатит',
    'простатит',
    'нечаянная бактериурия',
    'chronic bacterial prostatitis',
  ],
  'catheter-complication-mechanical': [
    'механическое осложнение катетера',
    'остранение катетера',
    'катетер',
...
export function searchDiseases(query) {
  ...
  return allDiseases
    .map((disease) => {
      ...
      const synonymTerms = (SEARCH_SYNONYMS[disease.id] || []).flatMap((term) =>
        buildSearchVariants(term)
      );
      let bestScore = -1;
...
// ===== УНИВЕРСАЛЬНЫЙ ПОИСК: болезни =====
// Примечание: поиск по препаратам (drugReferenceData) реализован сторо-
// ней точкой входа (см. src/data/lazyDataLoader.js) и здесь не дублируется,
// чтобы избежать мёртвого кода со статичным пустым снапшотом.
export function searchAll(query) {
  if (!query || query.length < 2) return { diseases: [], total: 0 };
