const androgenResistanceSyndromeData = {
  ...
  icon: '⚗️',
  description:
    'Редкое состояние, при котором ткани неадекватно отвечают на андрогены из-за дефекта рецептора.',
  tags: ['EAU 2025', 'Endocrine 2024'],
  relatedIds: ['hypogonadism', 'kallmann-syndrome', 'klein-felter'],
  definition:
    'Группа состояний, вызванных мутациями андрогенного рецептора, с вариабельной клинической картиной.',
  epidemiology:
    'Редкое генетическое заболевание с диапазоном проявлений от полной до частичной резистентности.',
  classification: [
    { type: 'Полная', desc: 'Полная нечувствительность к андрогенам' },
    { type: 'Частичная', desc: 'Вариабельная степень вирилизации и репродуктивных нарушений' },
  ],
  ...
  symptoms: [
    ...
    'Бесплодие',
    'Гинекомастия',
    'Недостаточная вирилизация',
  ],
  diagnostics: {
    primary: ['Генетическое тестирование', 'Тестостерон, ЛГ, ФСГ', 'Клиническая оценка фенотипа'],
    additional: ['Консультация генетика', 'УЗИ/МРТ по показаниям'],
    keyFindings: 'Несоответствие между уровнем андрогенов и клиническим фенотипом.',
  },
  treatment: [
    'Индивидуализированное мультидисциплинарное ведение',
    'Генетическое консультирование',
    'Психосексуальная поддержка',
  ...
  prognosis:
    'Зависит от формы; качество жизни улучшается при раннем мультидисциплинарном сопровождении.',
  followUp: 'Длительное наблюдение у андролога, эндокринолога и генетика.',
  lifestyleAdvice: [
    'Нужна психологическая и генетическая поддержка семьи.',
    'Важно наблюдение в специализированном центре.',
  ],
  nutritionAdvice: [
    'Специфической диеты нет; акцент на поддержании здорового веса и метаболического статуса.',
  ],
  patientRecommendations: [
    'Не откладывать генетическое консультирование при подозрении на DSD-синдром.',
    'Обсуждать вопросы фертильности и long-term план заранее.',
  ],
  clinicalCases: [
    {
      title: 'Клинический случай №1',
      patient: 'Подросток 16 лет',
      complaint: 'Нарушение полового развития.',
      findings: 'Высокий тестостерон, диспропорция фенотипа.',
      diagnosis: 'Частичная андрогенная резистентность.',
      treatment: 'Мультидисциплинарное сопровождение.',
      outcome: 'Уточнён генетический диагноз и тактика наблюдения.',
      lesson: 'Гормоны без фенотипа и генетики не дают полного диагноза.',
    },
  ],
  patientQuestions: [
    {
      q: 'Это наследуется?',
      a: 'Да, синдром связан с генетическим дефектом и требует консультации генетика.',
    },
  ],
  drugDoses: [],
};
