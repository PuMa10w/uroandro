  ...
  return (
    <footer className={`footer ${isHome ? 'footer-compact' : ''}`}>
        ...
        {links.map((link, i) => (
          <React.Fragment key={link.section}>
            <button
              ...
              onClick={() => onNavigate && onNavigate(link.section)}
            >
              {link.label}
            </button>
      ...
      <div className="footer-external-links">
        <a href="https://uroweb.org/guidelines" target="_blank" rel="noopener noreferrer">
          EAU Guidelines
        </a>
        <a href="https://www.auanet.org/guidelines" target="_blank" rel="noopener noreferrer">
          AUA Guidelines
        </a>
        <a href="https://cr.minzdrav.gov.ru" target="_blank" rel="noopener noreferrer">
